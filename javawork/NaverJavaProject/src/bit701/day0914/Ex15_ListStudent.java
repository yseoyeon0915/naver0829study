...
public class Ex15_ListStudent {
	...
	public Ex15_ListStudent() {
		...
		list.add(new Student("강호동",90,"o"));
		list.add(new Student("캔디",90,"a"));
		list.add(new Student("유재석",90,"b"));
	...
	public int getMenu()
	{
		...
		try {
			...
			num=4;//번호에 문자가 들어간 경우 4번. 전체출력로 하기
		}
		return num;
	}
	...
	public void searchStudent()
	{
		...
		//이름을 입력후 해당 학생이 있는 경우 이름,점수, 혈액형 출력
