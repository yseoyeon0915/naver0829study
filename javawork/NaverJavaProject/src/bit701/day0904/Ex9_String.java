...
public class Ex9_String {
	...
	public static void main(String[] args) {
        ...
        System.out.println(str2.toLowerCase()); //str1을 모두 소문자로 변환
        System.out.println(str2.toUpperCase()); //str2을 모두 대문자로 변환
        ...
        System.out.println(str1.indexOf('a')); //str1에서 첫번쨰 'a'의 인덱스값
        ...
        System.out.println(str1.compareTo(str2)) ; //str1과 str2의 차이(양수값:str1이 더 큰값, 음수값:str2가 더큰값
