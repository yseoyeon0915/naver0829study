...
public class Ex7_Format {
	...
	public static void main(String[] args) {
       ...
       //페턴을 이용해서 다양하게 날짜, 시간을 출력해보자
		Date date=new Date();
		
		//패턴 1
		SimpleDateFormat dateFormat1=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss EEE"); //MM:월 mm:분 EEE:요일짧게 HH:24시간 기준
		System.out.println(dateFormat1.format(date));
		
		//패턴 2
		SimpleDateFormat dateFormat2=new SimpleDateFormat("yyyy년MM월dd일 a hh:mm:ss EEE"); //a:오전/오후 EEEE:요일길게 hh:12시간 기준
		System.out.println(dateFormat1.format(date));
