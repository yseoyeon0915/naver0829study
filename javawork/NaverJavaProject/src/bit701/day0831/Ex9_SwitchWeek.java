...
public class Ex9_SwitchWeek {
	...
	public static void main(String[] args) {
	    ...
	    if(b) System.out.println("윤년");//조건에서 true는 생략가능 (b==false이 경우는 !b 이렇게 많이 씀)
	    ...
	    {
	    case 2:
	    	days=b?29:28;//b가 true면 윤년이므로 29일, 아닐경우 평년이므로 28을 days에 저장
	    	break;
	    case 4:
	    case 6:
	    case 9:
	    ...
	    System.out.printf("%d 년 %d월은 %d 일까지 있어요!!\n", year,month,days);
